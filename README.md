...
This is a module for use with Shadowdark RPG on Foundry VTT. The module provides implementations of community distributed or pay what you want content from various authors. All materials are provided with permission from the original creators. Consider supporting the content creators by purchasing their PDFs.
...
- Design, writing, map and layout: Jordan Rudd ([jordanrudd.itch.io](https://jordanrudd.itch.io/)) 
- Art: Jeri Honeywell (jerihoneywell@gmail.com)


**The Tragic Curse of Grimhill Fort**
- Reverse Ettin Games ([reverse-ettin-games.itch.io](https://reverse-ettin-games.itch.io/))
- Written and designed: Aleksandar Kostić aka Art of Caustic
- Editing and proofreading: Alex Bates


**Tomb of the dusk queen**
- Design: Sersa Victory ([sersavictory.itch.io](https://sersavictory.itch.io/))
- Front Cover Illustration: Jenn Mansell


**The Diabolical Lair of Professor Memnon**
- Writing and Graphic Design: Richard Jackson ([ersk.itch.io](https://ersk.itch.io/))


**The Awful Amber Doom**
- Reverse Ettin Games ([reverse-ettin-games.itch.io](https://reverse-ettin-games.itch.io/))
- Writing, Art, and Design: Aleksandar Kostic aka Caustic
- Writing, Editing, and Proofreading: Alex Bates


**The Lord of Mad Mansion**
- Sticky ([sticky-printing-press.itch.io](https://sticky-printing-press.itch.io/))
- Playtest: RED1, Mellow, Potato
- Cover Art: Margaret Brundage
- Cartography: Dyson Logos


**Against the Cult of the Crimson Hand**
- Runeforged Tabletop Gaming ([drivethrurpg](https://www.drivethrurpg.com/en/publisher/29262/runeforged-tabletop-gaming))
- Writing, Design, Dungeon Cartography, Layout: William Harshman (Runeforged). 
- Art: Dean Spencer, Jack Badashski, Gabe Fua
- Playtesters: Daniel Cotten, Danny “Travis Touchdown” Brown, James Martin, Sean Deiler.
- Proofreader: Danny “Travis Touchdown” Brown.
- Foundry Conversion: Supercorn


**Shrine of the Jaguar Princess**
- Sersa Victory ([linktr.ee/sersavictory](http://linktr.ee/sersavictory))
- Editing: Erin Kelley
...
- Supercorn
- John K. Watson ([github.com/jkwatson](https://github.com/jkwatson))
